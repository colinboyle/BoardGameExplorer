...
class TrendingGameCard extends StatelessWidget{
  ...
  //String _nameFirstWords;
  //String _nameLastWord;
  ...
  Widget build(BuildContext context){
    ...
    var _hashColors = new GetHashColors();//.getHashColors('hundred');
                           ...
                           //   children: <Widget>[
                                Wrap(
                                  ...
                                  Container(
                                    //width: 25,
                                    height: 15,
                                    decoration: BoxDecoration(color: _hashColors.getHashColors(gameData.category)[0], borderRadius: BorderRadius.all(Radius.circular(10))),
                                    child: Padding(padding: EdgeInsets.symmetric(horizontal: 5, vertical: 2), child: Text('${gameData.category}', style: Theme.of(context).textTheme.caption,),)
                                  ),
                                  Container(
                                    //width: 25,
                                    height: 15,
                                    decoration: BoxDecoration(color: _hashColors.getHashColors(gameData.mechanic)[0], borderRadius: BorderRadius.all(Radius.circular(10))),
                                    child: Padding(padding: EdgeInsets.symmetric(horizontal: 5, vertical: 2), child: Text('${gameData.mechanic}', style: Theme.of(context).textTheme.caption,),)
                                  ),
                                ],
                                ),
                            //  ],
